...
class VideoList extends StatelessWidget {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (v.status != DownloadStatus.pending &&
  ...
  String _getStatusText(VideoItem video) {
    switch (video.status) {
      case DownloadStatus.pending:
        return "Aguardando";
      case DownloadStatus.downloading:
        return "${(video.downloadProgress * 100).toStringAsFixed(1)}%";
  ...
  Color _getStatusColor(VideoItem video) {
    return switch (video.status) {
      DownloadStatus.downloading => Colors.blueAccent,
